...
*Construo aplicações web completas, desde APIs RESTful e bancos de dados até interfaces responsivas e escaláveis.*
...
| :--- | :--- | :--- |
| **Clean APP** | Sistema completo para gestão de vendas e controle de estoque | React 19 • TypeScript • Firebase |
| **CurriculoPro** | Plataforma SaaS para criação de currículos profissionais | Vue 3 • Node.js • Prisma |
| **FinanceApp** | App de gestão financeira pessoal inteligente | React • NestJS • MongoDB |
...
### 🌐 Front-end
`React` • `TypeScript` • `Vue.js` • `Vite` • `HTML5` • `CSS3` • `TailwindCSS`
...
### ⚙️ Back-end & Database
`Node.js` • `NestJS` • `PHP` • `PostgreSQL` • `MongoDB` • `Firebase` • `Prisma`
...
<div align="center"> 
  ...
  <a href="https://twitter.com/guilhermedev15"> 
    <img height="35" src="https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white"/> 
  </a> 
  ...
  <a href="https://wa.me/5511999999999"> 
    <img height="35" src="https://img.shields.io/badge/WhatsApp-25D366?style=for-the-badge&logo=whatsapp&logoColor=white"/> 
  </a> 
</div>
